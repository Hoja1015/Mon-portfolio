        ...
        >
          {SKILLS.map((skill, index) => (
            <motion.div
              ...
              className="relative group p-8 rounded-[2rem] bg-white border border-slate-900 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-sm hover:shadow-2xl hover:shadow-brand-primary/10 transition-all"
            >
